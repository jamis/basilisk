...
compile: dat/standard/*.bsk dat/snfist/*.bsk dat/scitadel/*.bsk bskcompile
	...
	@bskcompile dat/standard/index.bsk "dat/standard|dat/snfist|dat/scitadel|dat/dragon|dat/nbomt|dat/defenders|dat/tnblood|dat/boem|dat/diablo|dat/dungeon|dat/motp|dat/polyhedron"
